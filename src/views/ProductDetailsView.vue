  ...
  <div v-else class="mb-24 pt-2">
    ...
    >
      <img
        ...
        :src="`${api_url}/storage/images/products/${prod.gtins[0].images[0].url}`"
        :alt="prod.name"
      />
      <div class="flex flex-col px-5 sm:px-2 pb-5 sm:mt-5">
        <div class="flex justify-between">
          ...
          <div @click.prevent.stop="addFavorite(prod.id)">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
              class="size-7 text-orange-900"
            >
              <path
